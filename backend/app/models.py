...
class Notification(Base):
    """A customer notification (dashboard P16), generated idempotently from REAL events (policy
    breaches, quota crossings). Per-org; user_id NULL = org-wide. read_at is per-row. org_isolation RLS."""
