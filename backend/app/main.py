...
from .routers import (
    account, admin_anchors, admin_alerts, admin_campaigns, admin_data, admin_grading, admin_health,
...
for _r in (auth_staff, admin_orgs, admin_staff, admin_stats, admin_data, admin_inbox,
           admin_health, admin_grading, admin_anchors, admin_alerts, admin_campaigns):
