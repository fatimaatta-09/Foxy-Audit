...
from .routers import (
    ...
    passport, policies, sso, systems, verify, webhooks, coverage,
)
...
for _r in (auth_human, auth_google, health, logs, verify, passport, keys, billing, policies,
           analytics, coverage, anchors, leads, consent, account, badge, webhooks, sso, systems):
...
for _r in (auth_staff, admin_orgs, admin_staff, admin_stats, admin_data, admin_inbox,
           admin_health, admin_grading, admin_anchors, admin_alerts):
